...
input_raster = "output_dice_loss2.tif"
output_raster = "output_dice_loss2_blob_removed2.tif"

img = Image.open(input_raster)
img_arr = np.array(img)

noise_reduced  = morphology.remove_small_objects(label(img_arr), min_size=300, connectivity=1)
